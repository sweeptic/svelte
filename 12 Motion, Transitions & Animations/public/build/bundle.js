...
var app = (function () {
    ...
    // (59:4) {#each $cards as card, i (card.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$1, 59, 6, 1082);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:4) {#each $cards as card, i (card.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 57, 2, 1016);
    			attr_dev(div1, "class", "page svelte-1a1ekzd");
    			add_location(div1, file$1, 56, 0, 995);
    		},
    ...
    // (38:0) {#each boxes as box, i (Math.random())}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 38, 2, 773);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*discard*/ ctx[3].bind(this, /*box*/ ctx[7]))) /*discard*/ ctx[3].bind(this, /*box*/ ctx[7]).apply(this, arguments);
    						},
    						false,
    						false,
    						false,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:0) {#each boxes as box, i (Math.random())}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 34, 0, 648);
    			add_location(button, file, 35, 0, 691);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*addBox*/ ctx[2], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*discard, boxes*/ 10) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function discard(value) {
    		$$invalidate(1, boxes = boxes.filter(el => el !== value));
    	}
    	...
    	return [boxInput, boxes, addBox, discard, keydown_handler, input_binding];
    }
