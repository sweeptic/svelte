...
var app = (function () {
    ...
    // (52:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(52:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (55:2) <Button on:click={removeFromCart}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(55:2) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 56, 4, 1288);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(56:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	button0.$on("click", /*displayDescription*/ ctx[5]);
    	...
    	button1.$on("click", /*removeFromCart*/ ctx[6]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 48, 2, 1015);
    			attr_dev(h1, "class", "svelte-1td7xux");
    			add_location(h1, file$4, 49, 2, 1030);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 50, 2, 1049);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 47, 0, 1008);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*arr*/ 4) set_data_dev(t0, /*arr*/ ctx[2]);
    			if (!current || dirty & /*title*/ 1) set_data_dev(t2, /*title*/ ctx[0]);
    			if (!current || dirty & /*price*/ 2) set_data_dev(t4, /*price*/ ctx[1]);
    			const button0_changes = {};

    			if (dirty & /*$$scope, showDescription*/ 520) {
    ...
    class CartItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { title: 0, price: 1, id: 7 });
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 47, 6, 959);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (45:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(45:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 41, 2, 784);
    			add_location(p, file$3, 42, 2, 800);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$3, 43, 2, 825);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$3, 40, 0, 772);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*$timer*/ 1) set_data_dev(t3, /*$timer*/ ctx[0]);
