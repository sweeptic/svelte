...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 41, 4, 1101);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 34, 2, 843);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$3, 35, 2, 862);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$3, 33, 0, 836);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 36, 6, 741);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (34:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(34:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 31, 2, 591);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 32, 2, 607);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 30, 0, 579);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 26, 4, 458);
    			attr_dev(h2, "class", "svelte-12wunlm");
    			add_location(h2, file$1, 27, 4, 479);
    			attr_dev(p, "class", "svelte-12wunlm");
    			add_location(p, file$1, 28, 4, 500);
    			add_location(div0, file$1, 25, 2, 448);
    			add_location(div1, file$1, 30, 2, 532);
    			attr_dev(div2, "class", "product svelte-12wunlm");
    			add_location(div2, file$1, 24, 0, 424);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 21, 2, 444);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file, 20, 0, 432);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Button, Cart, Products, showCart });
