...
var app = (function () {
    ...
    // (37:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(37:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (40:2) <Button on:click={removeFromCart}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(40:2) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 41, 4, 1101);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(41:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 34, 2, 843);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 35, 2, 862);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 33, 0, 836);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (32:4) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:4) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 26, 4, 458);
    			attr_dev(h2, "class", "svelte-12wunlm");
    			add_location(h2, file$2, 27, 4, 479);
    			attr_dev(p, "class", "svelte-12wunlm");
    			add_location(p, file$2, 28, 4, 500);
    			add_location(div0, file$2, 25, 2, 448);
    			add_location(div1, file$2, 30, 2, 532);
    			attr_dev(div2, "class", "product svelte-12wunlm");
    			add_location(div2, file$2, 24, 0, 424);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
