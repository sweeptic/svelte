...
var app = (function () {
    ...
    /* src/Cart/CartItem.svelte generated by Svelte v3.59.2 */
    const file$4 = "src/Cart/CartItem.svelte";

    // (35:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(35:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (38:2) <Button on:click={removeFromCart}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(38:2) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 39, 4, 1042);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(39:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 32, 2, 784);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 33, 2, 803);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 31, 0, 777);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Cart/Cart.svelte generated by Svelte v3.59.2 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 41, 6, 853);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 36, 2, 703);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$3, 37, 2, 719);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$3, 35, 0, 691);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (23:4) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(23:4) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 17, 4, 332);
    			attr_dev(h2, "class", "svelte-12wunlm");
    			add_location(h2, file$2, 18, 4, 353);
    			attr_dev(p, "class", "svelte-12wunlm");
    			add_location(p, file$2, 19, 4, 374);
    			add_location(div0, file$2, 16, 2, 322);
    			add_location(div1, file$2, 21, 2, 406);
    			attr_dev(div2, "class", "product svelte-12wunlm");
    			add_location(div2, file$2, 15, 0, 298);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Products/Products.svelte generated by Svelte v3.59.2 */
    ...
    // (23:2) {#each $products as product (product.id)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(23:2) {#each $products as product (product.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 21, 2, 444);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file$1, 20, 0, 432);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (14:0) <Button   on:click={() => {     showCart = !showCart;   }}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(14:0) <Button   on:click={() => {     showCart = !showCart;   }}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			button.$set(button_changes);
    			if (!current || dirty & /*$timer*/ 2) set_data_dev(t2, /*$timer*/ ctx[1]);
