...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 10, 0, 133);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 12, 0, 233);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "input", /*setValue*/ ctx[1], false, false, false, false),
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ value, setValue });
    	...
    	return [value, setValue, input1_input_handler];
    }
