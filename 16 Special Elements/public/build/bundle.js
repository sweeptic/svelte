...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(13:2) {#if member.isParent}",
    		ctx
    	});
    ...
    // (14:4) {#each member.children as child}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(14:4) {#each member.children as child}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 11, 2, 102);
    			attr_dev(div, "class", "svelte-1bkle0x");
    			add_location(div, file$1, 10, 0, 94);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (member === undefined && !('member' in $$props || $$self.$$.bound[$$self.$$.props['member']])) {
    			console.warn("<FamilyNode> was created without expected prop 'member'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<FamilyNode> was created with unknown prop '${key}'`);
    	});
    ...
    // (36:0) {#each familyStructure as familyMember}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:0) {#each familyStructure as familyMember}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(button, file, 31, 0, 759);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*renderedComponent*/ 1 && switch_value !== (switch_value = /*renderedComponent*/ ctx[0].cmp)) {
    				if (switch_instance) {
    					group_outros();
